...
public class DirectedEdge { 
     final int v;        //My commit: way private final - changed because of blacklist.
     final int w;        //My commit: way private final - changed because of blacklist.
     double weight;      //My commit: way private final - changed because of blacklist.
    ...
    /*//I add this. Need to set blacklist edges to inf.
